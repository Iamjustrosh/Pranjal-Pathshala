...
import PostActionNotificationDialog from '@/components/admin/PostActionNotificationDialog';
    ...
    try {
      ...
      if (!assessment) {
        ...
        if (
          ...
          throw new Error(
            'Select a valid academic year before creating the assessment.'
          );
        }

        assessment = await createAssessment(supabase, {
  ...
  return (
    ...
    <>
      ...
      <PostActionNotificationDialog
        ...
        title={
          notificationPrompt
            ? `${notificationPrompt.assessment.title} Result Published`
            : ''
        }
        body={
          notificationPrompt
            ? `Your result for ${notificationPrompt.assessment.title} is now available.`
            : ''
        }
        actionUrl="/student-dashboard?tab=performance"
        recipients={
          notificationPrompt
            ? [
              {
                studentId:
                  notificationPrompt.student.student_id,
                academicRecordId:
                  notificationPrompt.student
                    .academic_record_id,
              },
            ]
            : []
        ...
        contextLabel={
          notificationPrompt
            ? `${notificationPrompt.student.student_name} • ${notificationPrompt.student.uid}`
            : ''
        }
      />
    </>
  ...
  return (
    <>
      ...
      <PostActionNotificationDialog
        ...
        title={
          notificationPrompt
            ? `${notificationPrompt.assessment.title} Result Updated`
            : ''
        }
        body={
          notificationPrompt
